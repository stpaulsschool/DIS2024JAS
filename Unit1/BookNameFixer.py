...
while Repeat == "yes" or Repeat == "y":  #Allows the program to be run repeatedly
    ...
    #NoWords = 1  #There will always be at least 1 word
    #for Letter in Name:  #Check every character in the word...
    #    if Letter == " ":  #...for if it's a space...
    #        NoWords = NoWords + 1  #... and if it is, acknowledge another word

    #alternatively...
    NoWords = 0  #Start counting at 0
    for Word in Name.split():  #For every Nowords in the title...
        NoWords = NoWords + 1  #...acknowledge another word

    print(" ")
    if NoWords > 2:  #If there are more than 2 words...
        print("That's a long title... May I recommend shortening it to below three words?")  #...recommend less words
    elif NoWords == 0:  #Otherwise, if there are no words...
        print("Hold on, you didn't even supply a title!")  #...comment on the lack of words
    elif NoWords <= 2:  #Otherwise, if there are less than, or exactly 2 words...
